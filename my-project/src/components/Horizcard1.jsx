...
const Horizcard1 = (props) => {
   
  
    
  return (
    <div className='flex bg-white shadow-sm mt-10 h-50 '>
        <div>
        <div className='flex bg-orange-400 rounded-r-lg  relative top-[-5px]'>
            <div className='p-2'>{props.icon}</div>
            <div className='text-white'>{props.choice}</div>
        </div>
        <div>
           <img src='/laptop.png'/>
        </div>
        ...
        <div className='ml-14 mr-14 mt-5 text-[17px] '>
            ...
            <div><b> Main highlights</b></div>
           {/* <div><Highlights/></div> */}
            <div className='m-5'>[What You Get]: Receive the WixPro website builder suite, access to premium design templates, an extensive library of widgets and apps, and detailed step-by-step guides.</div>
            <div className='flex'> 
